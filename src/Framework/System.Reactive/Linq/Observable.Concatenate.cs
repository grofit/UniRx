...
namespace System.Reactive.Linq
{
    ...
    public static partial class Observable
    {
        ...
        {
            if (sources.Length == 0) return System.Reactive.Linq.Observable.Return(new T[0]);
        ...
        {
            if (sources.Length == 0) return System.Reactive.Linq.Observable.ReturnUnit();
        ...
        {
            return System.Reactive.Linq.Observable.Return(value, scheduler).Concat(source);
        }
