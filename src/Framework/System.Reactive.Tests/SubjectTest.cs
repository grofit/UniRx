    ...
    public class SubjectTests
    {
        ...
        public void Subject()
        {
            // OnCompletedPattern
            {
                ...
                subject.OnNext(100);
                subject.OnNext(1000);
                AssertEx.IsCollection(onNext, 1, 10, 100, 1000);
        ...
        public void AsyncSubjectTest()
        {
            // OnCompletedPattern
            {
                ...
                subject.OnCompleted();
                AssertEx.IsCollection(onNext, 1000);
                onCompletedCallCount.Is(1);
                ...
                // ++subscription
                subject.Subscribe(x => onNext.Add(x), x => exception.Add(x), () => onCompletedCallCount++);
                AssertEx.IsCollection(onNext, 1000, 1000);
                exception.Count.Is(0);
        ...
        public void BehaviorSubject()
        {
            // OnCompletedPattern
            {
                ...
                AssertEx.IsCollection(onNext, 3333);
                ...
                AssertEx.IsCollection(onNext, 3333, 1, 10, 100, 1000);
        ...
        public void ReplaySubjectBufferReplay()
        {
            ...
            AssertEx.IsCollection(onNext, 100, 1000, 10000);  // cut 1, 10

            // replay subscription
            onNext.Clear();
            _.Dispose();
            subject.Subscribe(x => onNext.Add(x), x => exception.Add(x), () => onCompletedCallCount++);
            AssertEx.IsCollection(onNext, 100, 1000, 10000);

            subject.OnNext(20000);
            AssertEx.IsCollection(onNext, 1000, 10000, 20000);
        ...
        public void ReplaySubjectWindowReplay()
        {
            ...
            onNext.Clear();
            subject.Subscribe(x => onNext.Add(x), x => exception.Add(x), () => onCompletedCallCount++);
            AssertEx.IsCollection(onNext, 10, 100);
            ...
            onNext.Clear();
            subject.Subscribe(x => onNext.Add(x), x => exception.Add(x), () => onCompletedCallCount++);
            AssertEx.IsCollection(onNext, 100, 1000);
            ...
            onNext.Clear();
            subject.Subscribe(x => onNext.Add(x), x => exception.Add(x), () => onCompletedCallCount++);
            AssertEx.IsCollection(onNext, 10000, 2, 20);
        }
    }
}
