...
namespace System.Reactive.Tests
{
    ...
    public class ObservableConcatTest
    {
        ...
        public void Merge()
        {
            ...
            AssertEx.IsCollection(list, 10, 20, 100, 50);
        ...
        public void MergeConcurrent()
        {
            ...
            AssertEx.IsCollection(list, 10, 20, 50);
            ...
            AssertEx.IsCollection(list, 500);
            complete.IsFalse();
        ...
        public void Switch()
        {
            ...
            AssertEx.IsCollection(list, 100, 2000, 5000, 900000);
            s2.OnCompleted();
        }
    }
}
